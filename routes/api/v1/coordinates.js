...
router.get('/:id', validateObjectId, coordinatesController.getCoordinateById);
...
router.put('/:id', auth, checkRole('admin'), validateObjectId, coordinatesController.updateCoordinate);

// Route to delete a coordinate by ID
router.delete('/:id', auth, checkRole('admin'), validateObjectId, coordinatesController.deleteCoordinate);
